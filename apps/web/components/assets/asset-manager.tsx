        ...
        {assetCategories.map((category) => (
          ...
          >
            <div className="flex items-center gap-2">
              <category.icon
                className={`w-4 h-4 ${selectedCategory === category.id
                    ? "text-primary"
                ...
                <div className="grid grid-cols-3 gap-3">
                  {filteredAssets.map((asset) => (
                    <div
                      ...
                      className={`group relative aspect-square rounded-lg border overflow-hidden cursor-pointer transition-all ${selectedAsset?.key === asset.key
                ...
                <div className="space-y-2">
                  {filteredAssets.map((asset) => (
                    <div
                      ...
                      className={`group flex items-center gap-3 p-2 rounded-lg border cursor-pointer transition-all ${selectedAsset?.key === asset.key
                          ? "ring-2 ring-primary border-primary"
                          : "border-border hover:border-primary/50"
                        }`}
                    >
